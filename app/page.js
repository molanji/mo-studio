...
function ToolCard({ tool }) {
  return (
    <Link href={tool.href} style={{ display: 'block', textDecoration: 'none' }}>
      <div
        style={{
      ...
      >
        ...
        <div style={{
          ...
          background: tool.accent, borderRadius: '16px 16px 0 0',
        }} />

        {/* Live badge */}
        <div style={{
          position: 'absolute', top: 18, right: 18,
          background: 'rgba(12,40,24,0.8)', border: '1px solid #0C2818',
          borderRadius: 99, padding: '3px 10px', fontSize: '0.7rem',
          fontWeight: 600, color: '#B8EAC4',
        ...
        <div style={{ fontSize: '2rem', marginBottom: 16, marginTop: 8 }}>{tool.icon}</div>
        <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#F0F0F0',
          marginBottom: 8, letterSpacing: '-0.01em' }}>{tool.name}</h3>
        <p style={{ fontSize: '0.875rem', color: '#666', lineHeight: 1.6,
          marginBottom: 24 }}>{tool.description}</p>
        <div style={{
...
export default function Dashboard() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#111', padding: '0 24px 80px' }}>
      {/* Header */}
      <header style={{
        maxWidth: 960, margin: '0 auto', padding: '40px 0 56px',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <span style={{ fontSize: '1.1rem', fontWeight: 800,
            letterSpacing: '-0.02em', color: '#F0F0F0' }}>MO Studio</span>
        </div>
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', paddingTop: 64 }}>
        ...
        <h2 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', fontWeight: 800,
          letterSpacing: '-0.03em', color: '#F0F0F0', lineHeight: 1.1, marginBottom: 12 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: 16, padding: 28, minHeight: 200,
            display: 'flex', flexDirection: 'column',
            alignItems: 'flex-start', justifyContent: 'center',
          }}>
            <div style={{ fontSize: '2rem', marginBottom: 12, opacity: 0.3 }}>＋</div>
            <p style={{ color: '#444', fontSize: '0.875rem' }}>More tools coming soon</p>
          </div>
        </div>
      </div>
    </div>
